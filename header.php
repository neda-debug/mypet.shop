			...
			<div class="row">
				...
				<ul class= "annoucement-bar__list">
				 ...
				 <i class="bi bi-envelope rounded-circle"></i>
					 <a href= "mail to: hello@pawsgang.shop" class= "text-decoration-none">hello@pawsgang.shop</a>
				 </li>
				</ul>
...
<a class="cart-customlocation" href="<?php echo wc_get_cart_url(); ?>" title="<?php _e( 'View your shopping cart' ); ?>"><?php echo 
sprintf ( _n( '%d item', '%d items', WC()->cart->get_cart_contents_count() ), WC()->cart->get_cart_contents_count() ); ?> – <?php echo WC()->cart->get_cart_total(); ?></a>
				</div>
